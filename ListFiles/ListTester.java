 ...
 * get you started.
 * 
 * @author trevorsmith772, mvail, mhthomas, amussell (lambdas)
 */
public class ListTester {
	...
	private void runTests() {
		...
		if(SUPPORTS_LIST_ITERATOR) {
			testTwoElementList(A_newListIteratorAddB_BA, "A_newListIteratorAddB_BA", LIST_BA, STRING_BA);
		...
		testSingleElementList(AB_iterRemoveAfterNext2B_A, "AB_iterRemoveB_A", LIST_A, STRING_A);
		if(SUPPORTS_LIST_ITERATOR) {
			testSingleElementList(AB_listIterRemoveAfterNextA_B, "AB_listIterRemoveAfterNextA_B", LIST_B, STRING_B);
			testSingleElementList(AB_listIterRemoveAfterNext2B_A, "AB_listIterRemoveAfterNext2B_A", LIST_A, STRING_A);
		...
		if(SUPPORTS_LIST_ITERATOR) {
			testThreeElementList(AB_newListIterAddC_CAB, "AB_newListIterAddC_CAB", LIST_CAB, STRING_CAB);
		...
		testTwoElementList(ABC_iterRemoveAfterNext2B_AC, "ABC_iterRemoveAfterNext2B_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_iterRemoveAfterNext3C_AB, "ABC_iterRemoveAfterNext3C_AB", LIST_AB, STRING_AB);
		if(SUPPORTS_LIST_ITERATOR) {
			testTwoElementList(ABC_listIterRemoveAfterNextA_BC, "ABC_listIterRemoveAfterNextA_BC", LIST_BC, STRING_BC);
			testTwoElementList(ABC_listIterRemoveAfterNext2B_AC, "ABC_listIterRemoveAfterNext2B_AC", LIST_AC, STRING_AC);
			testTwoElementList(ABC_listIterRemoveAfterNext3C_AB, "ABC_listIterRemoveAfterNext3C_AB", LIST_AB, STRING_AB);
	...
	/** Scenario: [A,B] -> iteratorRemoveAfterNext2B -> [A] 
	 * @return [A] after iteratorRemoveAfterNext2B
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterNext2B_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_iterRemoveAfterNext2B_A = () -> AB_iterRemoveAfterNext2B_A();
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfterNext2B -> [A,C] 
	 * @return [A,C] after iteratorRemoveAfterNext2B
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterNext2B_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_iterRemoveAfterNext2B_AC = () -> ABC_iterRemoveAfterNext2B_AC();

	/** Scenario: [A,B,C] -> iteratorRemoveAfterNext3C -> [A,B] 
	 * @return [A,B] after iteratorRemoveAfterNext3C
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterNext3C_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_iterRemoveAfterNext3C_AB = () -> ABC_iterRemoveAfterNext3C_AB();
	...
	/** Scenario: [A,B] -> listIteratorRemoveAfterNext2B -> [A] 
	 * @return [A] after listIteratorRemoveAfterNext2B
	 */
	private IndexedUnsortedList<Integer> AB_listIterRemoveAfterNext2B_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_listIterRemoveAfterNext2B_A = () -> AB_listIterRemoveAfterNext2B_A();
	...
	/** Scenario: [A,B,C] -> listIteratorRemoveAfterNext2B -> [A,C] 
	 * @return [A,C] after listIteratorRemoveAfterNext2B
	 */
	private IndexedUnsortedList<Integer> ABC_listIterRemoveAfterNext2B_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_listIterRemoveAfterNext2B_AC = () -> ABC_listIterRemoveAfterNext2B_AC();

	/** Scenario: [A,B,C] -> listIteratorRemoveAfterNext3C -> [A,B] 
	 * @return [A,B] after listIteratorRemoveAfterNext3C
	 */
	private IndexedUnsortedList<Integer> ABC_listIterRemoveAfterNext3C_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_listIterRemoveAfterNext3C_AB = () -> ABC_listIterRemoveAfterNext3C_AB();

	/** Scenario: [A] -> listIteratorRemoveAfterPreviousA -> [ ] 
	 * @return [ ] after listIteratorRemoveAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> listIteratorRemoveAfterPreviousA -> [B] 
	 * @return [B] after listIteratorRemoveAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> listIteratorRemoveAfterPreviousB -> [A] 
	 * @return [A] after listIteratorRemoveAfterPreviousB
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorRemoveAfterPreviousA -> [B,C] 
	 * @return [B,C] after listIteratorRemoveAfterPreviousA
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorRemoveAfterPreviousB -> [A,C] 
	 * @return [A,C] after listIteratorRemoveAfterPreviousB
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorRemoveAfterPreviousC -> [A,B] 
	 * @return [A,B] after listIteratorRemoveAfterPreviousC
	 */
	...
	/** Scenario: [ ] -> listIteratorAddA -> [A] 
	 * @return [A] after listIteratorAddA
	 */
	...
	/** Scenario: [A] -> newListIteratorAddB -> [B,A] 
	 * @return [B,A] after newListIteratorAddB
	 */
	private IndexedUnsortedList<Integer> A_newListIteratorAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_listIterAddA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_newListIteratorAddB_BA = () -> A_newListIteratorAddB_BA();

	/** Scenario: [A] -> listIteratorAddBAfterNextA -> [A,B] 
	 * @return [A,B] after listIteratorAddBAfterNextA
	 */
	...
	/** Scenario: [A] -> listIteratorAddBAfterPreviousA -> [B,A] 
	 * @return [B,A] after listIteratorAddBAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> newListIteratorAddC -> [C,A,B] 
	 * @return [C,A,B] after newListIteratorAddC
	 */
	private IndexedUnsortedList<Integer> AB_newListIterAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_listIterAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_newListIterAddC_CAB = () -> AB_newListIterAddC_CAB();

	/** Scenario: [A,B] -> listIteratorAddCAfterNextA -> [A,C,B] 
	 * @return [A,C,B] after listIteratorAddCAfterNextA
	 */
	...
	/** Scenario: [A,B] -> listIteratorAddCAfterNextB -> [A,B,C] 
	 * @return [A,B,C] after listIteratorAddCAfterNextB
	 */
	...
	/** Scenario: [A,B] -> listIteratorAddCAfterPreviousA -> [C,A,B] 
	 * @return [C,A,B] after listIteratorAddCAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> listIteratorAddCAfterPreviousB -> [A,C,B] 
	 * @return [A,C,B] after listIteratorAddCAfterPreviousB
	 */
	...
	/** Scenario: [A] -> listIteratorSetBAfterNextA -> [B] 
	 * @return [B] after listIteratorSetBAfterNextA
	 */
	...
	/** Scenario: [A] -> listIteratorSetBAfterPreviousA -> [B] 
	 * @return [B] after listIteratorSetBAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> listIteratorSetCAfterNextA -> [C,B] 
	 * @return [C,B] after listIteratorSetCAfterNextA
	 */
	...
	/** Scenario: [A,B] -> listIteratorSetCAfterNextB -> [A,C] 
	 * @return [A,C] after listIteratorSetCAfterNextB
	 */
	...
	/** Scenario: [A,B] -> listIteratorSetCAfterPreviousA -> [C,B] 
	 * @return [C,B] after listIteratorSetCAfterPreviousA
	 */
	...
	/** Scenario: [A,B] -> listIteratorSetCAfterPreviousB -> [A,C] 
	 * @return [A,C] after listIteratorSetCAfterPreviousB
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterNextA -> [D,B,C] 
	 * @return [D,B,C] after listIteratorSetDAfterNextA
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterNextB -> [A,D,C] 
	 * @return [A,D,C] after listIteratorSetDAfterNextB
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterNextC -> [A,B,D] 
	 * @return [A,B,D] after listIteratorSetDAfterNextC
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterPreviousA -> [D,B,C] 
	 * @return [D,B,C] after listIteratorSetDAfterPreviousA
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterPreviousB -> [A,D,C] 
	 * @return [A,D,C] after listIteratorSetDAfterPreviousB
	 */
	...
	/** Scenario: [A,B,C] -> listIteratorSetDAfterPreviousC -> [A,B,D] 
	 * @return [A,B,D] after listIteratorSetDAfterPreviousC
	 */
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveElement0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveElement1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testLast", testLast(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testContainsElement0" + contentsString.charAt(0), testContains(scenario.build(), contents[0], Result.True));
			printTest(scenarioName + "_testContainsElement1" + contentsString.charAt(1), testContains(scenario.build(), contents[1], Result.True));
			printTest(scenarioName + "_testContainsX", testContains(scenario.build(), ELEMENT_X, Result.False));
			printTest(scenarioName + "_testIsEmpty", testIsEmpty(scenario.build(), Result.False));
			...
			printTest(scenarioName + "_testAddToFront", testAddToFront(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddToRear", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterElement0" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterElement1" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
			...
			printTest(scenarioName + "_testIndexOfElement0" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
			printTest(scenarioName + "_testIndexOfElement1" + contentsString.charAt(1), testIndexOf(scenario.build(), contents[1], 1));
			printTest(scenarioName + "_testIndexOfX", testIndexOf(scenario.build(), ELEMENT_X, -1));
			printTest(scenarioName + "_testRemoveNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter2PrevPrevRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(2), 2), Result.NoException));
			} else {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.UnsupportedOperation));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.UnsupportedOperation));
			}
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveElement0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveElement1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveElement2" + contentsString.charAt(2), testRemoveElement(scenario.build(), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testLast", testLast(scenario.build(), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testContainsElement0" + contentsString.charAt(0), testContains(scenario.build(), contents[0], Result.True));
			printTest(scenarioName + "_testContainsElement1" + contentsString.charAt(1), testContains(scenario.build(), contents[1], Result.True));
			printTest(scenarioName + "_testContainsElement2" + contentsString.charAt(2), testContains(scenario.build(), contents[2], Result.True));
			printTest(scenarioName + "_testContainsX", testContains(scenario.build(), ELEMENT_X, Result.False));
			printTest(scenarioName + "_testIsEmpty", testIsEmpty(scenario.build(), Result.False));
			...
			printTest(scenarioName + "_testAddAfterElement0" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterElement1" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[1], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterElement2" + contentsString.charAt(2), testAddAfter(scenario.build(), contents[2], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
			...
			printTest(scenarioName + "_testIndexOfElement0" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
			printTest(scenarioName + "_testIndexOfElement1" + contentsString.charAt(1), testIndexOf(scenario.build(), contents[1], 1));
			printTest(scenarioName + "_testIndexOfElement2" + contentsString.charAt(2), testIndexOf(scenario.build(), contents[2], 2));
			printTest(scenarioName + "_testIndexOfX", testIndexOf(scenario.build(), ELEMENT_X, -1));
			printTest(scenarioName + "_testRemoveNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			...
			printTest(scenarioName + "_iterNextRemove_iterNext_iterNext_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.False));
			printTest(scenarioName + "_iterNextRemove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), contents[1], Result.MatchingValue));
			...
			printTest(scenarioName + "_iterNextRemove_iterNext_iterNext_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter3PrevPrevRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(3), 2), Result.NoException));
				printTest(scenarioName + "_testListIter3PrevPrevPrevRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(3), 3), Result.NoException));
			} else {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.UnsupportedOperation));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.UnsupportedOperation));
			}
